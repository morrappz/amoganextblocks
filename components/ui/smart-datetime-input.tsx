...
import { ActiveModifiers, OnSelectHandler } from "react-day-picker";
  ...
  (
    {
      ...
      value,
      locale = localeEnUS,
      hour12 = localesUsings12HourTime.includes(locale.code as string),
      onValueChange,
      placeholder,
      disabled,
      ...dateTimeInputProps
      ...
      <PopoverContent className="w-auto p-0" sideOffset={8}>
        <div className="flex gap-1">
          <Calendar
            ...
            onSelect={formateSelectedDate as OnSelectHandler<Date | undefined>}
            initialFocus
          />
