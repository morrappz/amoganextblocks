...
export default function AnalyticChat({
  ...
  const [dbConnectionString, setDbConnectionString] = useState<string>(
    "postgresql://morr:YN59m0Q9QvZvFGGPtKPHGjRV1eQtQpsXy3Rlwx9Wg3jFlVpYaumgXA6ETn4hMXi1@219.93.129.146:5443/amogademo"
  );
  ...
  const {
    ...
    body: {
      apiKey:
        "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",
    },
