...
interface ViewOption {
  value: string;
  label: string;
  component: React.ComponentType<{ records: FileUpload[]; table: Table<FileUpload> }> | null;
}
...
export function RecordsTable({ promises }: RecordsTableProps) {
  ...
  const [rowAction, setRowAction] =
    React.useState<DataTableRowAction<FileUpload> | null>(null);
   ...
   */
  const filterFields: DataTableFilterField<FileUpload>[] = [
    {
      id: "file_name",
      label: "file_name",
    ...
    },
    {
      id: "status",
      label: "Status",
      options: FileUploadStatuses.map((status) => ({
   ...
   */
  const advancedFilterFields: DataTableAdvancedFilterField<FileUpload>[] = [
    {
      id: "file_name",
      label: "file_name",
      type: "text",
  ...
  const { table } = useDataTable({
    ...
    getRowId: (originalRow) => originalRow.file_upload_id?.toString(),
    shallow: false,
    clearOnDefault: true,
  });
            ...
            endContent={
              <>
                ...
                <Button
                  size="sm"
                  onClick={() =>
                    setRowAction({ row: {} as Row<FileUpload>, type: "new" })
                  }
                >
