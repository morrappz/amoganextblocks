...
import { deleteChat } from "@/app/(authenticated)/aichat/lib/actions";
...
const HistoryBar = ({ open, setOpen, data, title, fetchHistory }: Props) => {
                ...
                >
                  <div className="flex justify-between items-center gap-2">
                    <div className="flex justify-between items-center gap-2">
                      ...
                      <Link href={`/store-sales-dashboard/chat/${prompt.id}`}>
                        {prompt.title}
                      </Link>
                    </div>
                    <Trash
