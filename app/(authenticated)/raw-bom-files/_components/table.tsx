...
interface ViewOption {
  value: string;
  label: string;
  component: React.ComponentType<{ records: MyDoc[]; table: Table<MyDoc> }> | null;
}
...
export function RecordsTable({ promises }: RecordsTableProps) {
  ...
  const [rowAction, setRowAction] =
    React.useState<DataTableRowAction<MyDoc> | null>(null);
   ...
   */
  const filterFields: DataTableFilterField<MyDoc>[] = [
    {
      id: "doc_name",
      label: "doc_name",
    ...
    },
    {
      id: "status",
      label: "Status",
      options: myDocStatuses.map((status) => ({
   ...
   */
  const advancedFilterFields: DataTableAdvancedFilterField<MyDoc>[] = [
    {
      id: "doc_name",
      label: "doc_name",
      type: "text",
  ...
  const { table } = useDataTable({
    ...
    getRowId: (originalRow) => originalRow.mydoc_id?.toString(),
    shallow: false,
    clearOnDefault: true,
  });
            ...
            endContent={
              <>
                ...
                <Button
                  size="sm"
                  onClick={() =>
                    setRowAction({ row: {} as Row<MyDoc>, type: "new" })
                  }
                >
