...
interface ViewOption {
  value: string;
  label: string;
  component: React.ComponentType<{ records: DataUpload[]; table: Table<DataUpload> }> | null;
}
...
export function RecordsTable({ promises }: RecordsTableProps) {
  ...
  const [rowAction, setRowAction] =
    React.useState<DataTableRowAction<DataUpload> | null>(null);
   ...
   */
  const filterFields: DataTableFilterField<DataUpload>[] = [
    {
      id: "file_name",
      label: "file_name",
    ...
    },
    {
      id: "status",
      label: "Status",
      options: DataUploadStatuses.map((status) => ({
   ...
   */
  const advancedFilterFields: DataTableAdvancedFilterField<DataUpload>[] = [
    {
      id: "file_name",
      label: "file_name",
      type: "text",
  ...
  const { table } = useDataTable({
    ...
    getRowId: (originalRow) => originalRow.data_upload_id?.toString(),
    shallow: false,
    clearOnDefault: true,
  });
            ...
            endContent={
              <>
                ...
                <Button
                  size="sm"
                  onClick={() =>
                    setRowAction({ row: {} as Row<DataUpload>, type: "new" })
                  }
                >
