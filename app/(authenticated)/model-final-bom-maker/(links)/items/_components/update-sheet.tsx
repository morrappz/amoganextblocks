  ...
  return (
    <Dialog {...props}>
      <DialogContent className="sm:max-w-ld max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>
            {isNew ? "Create Model Final BOM Item" : "Update Model Final BOM Item"}
          </DialogTitle>
          <DialogDescription>
            {isNew
              ? "Enter details to create a new Model Final BOM Item."
              : "Update the Model Final BOM item details and save the changes."}
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
          <form
