...
export default function Step4({
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const { success, insertedCount, totalItems, error, errors } = response.data;
      ...
      if (!success) {
        ...
        setIsSaved(true);
        setSuccessMessage(`Uploaded ${insertedCount} records out of ${totalItems} records successfully.`);
        ...
        <>
          <div className="space-y-2">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Final BOM Name</FormLabel>
                  <FormControl>
                    <Input
                      className="resize-none"
                      placeholder="Final BOM Name"
                      {...field}
                      onChange={(e) => {
                        field.onChange(e);
          ...
          <div className="space-y-2">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Final BOM Description</FormLabel>
                  <FormControl>
                    <Input
                      className="resize-none"
                      placeholder="Final BOM Description"
                      {...field}
                      onChange={(e) => {
                        field.onChange(e);
        ...
        <div className="mt-4 space-y-4">
          ...
          {/* <div className="flex flex-col md:flex-row items-center justify-center gap-4 mt-4">
            ...
            onClick={() => {
              ...
              location.href = "/finalbommaker"
            }}>
              ← Back to Final BOM Maker
            </Button>
            <Button
