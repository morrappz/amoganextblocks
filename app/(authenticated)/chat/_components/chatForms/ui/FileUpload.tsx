...
const FileUpload = ({ form_json }: { form_json: form_json }) => {
    ...
    <div>
      ...
      <div>
        <Input
          ...
          ref={fileInputRef}
        />
        <div className="bg-muted border-dashed border-black border-2 flex flex-col justify-center items-center min-h-[250px]">
          <div
