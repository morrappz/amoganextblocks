...
export const metadata: Metadata = {
  title: "Raw BOM Upload",
  description: "View your Raw BOM Upload data",
};
...
export default async function IndexPage(props: IndexPageProps) {
  ...
  if (error || !data) {
    console.error("Error fetching Raw BOM Upload data:", error);
    return <div>Error fetching Raw BOM Upload data</div>;
  }
  ...
  return (
    <Shell className="gap-2">
      <div className="pb-2">
        <p className="text-muted-foreground">view the uploaded Raw BOM data</p>
      </div>
